...
training_port=20004
max_seq_length=2048
dataset_name="/scratch/mc_lmy/datas/11-27-craft-10-shell_agent-hard/craft_snow_block/output/11-27-craft-10-shell_agent-hard-llama-3-h0"
version="mc_llama3-llava-next-8b-hf-full-11-27-craft-snow_block-shell_agent-hard-llama-3-h0-12-06-1"  # {model_version}_{dataset_version}_{training_date}"
