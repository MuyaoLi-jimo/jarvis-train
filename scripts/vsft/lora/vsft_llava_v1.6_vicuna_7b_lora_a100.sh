...
version="mc-llava_v1.6_vicuna_7b-lora-embodied_mini_craft_table-10-05"  # {model_version}_{dataset_version}_{training_date}
...
deepspeed --include localhost:$cuda_visible_devices --master_port=$training_port ultron/model/train/vsft.py \
    ...
    --model_name_or_path "/nfs-shared/models/llava-v1.6-vicuna-7b-hf" \
    --report_to "wandb" \
