...
training_port=20011
dataset_name="/home/mc_lmy/datas/10-08_craft-10_dataset/embodied_mini_craft_10-10-08-llava-v1.6"
...
deepspeed --include localhost:$cuda_visible_devices --master_port=$training_port ultron/model/train/vsft.py \
	...
	--model_name_or_path "/home/mc_lmy/model/llava-v1.6-vicuna-13b-hf" \
	--report_to "wandb" \
