...
version="mc-llava_v1.6_mistral_13b-lora-embodied_mini_craft_table-10-05"   # {model_version}_{dataset_version}_{training_date}-{training date}
...
export WANDB_NOTES="[24-10-05] 18668 vision language convs (instruction state action)"

deepspeed --include localhost:$cuda_visible_devices --master_port=$training_port ultron/model/train/vsft.py \
    --dataset_name $dataset_name \
    --model_name_or_path "/nfs-shared/models/llava-v1.6-vicuna-13b-hf" \
    --report_to "wandb" \
