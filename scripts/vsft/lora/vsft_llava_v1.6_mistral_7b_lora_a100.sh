...
version="mc-llava_v1.6_mistral_7b-lora-embodied_mini_10-30-craft-craft_table-shell_agent-normal-mistral-11-04"  # {model_version}_{dataset_version}_{training_date}"
...
export WANDB_NOTES="[24-11-04] 4.75k vision language convs convs (instruction state action)"
