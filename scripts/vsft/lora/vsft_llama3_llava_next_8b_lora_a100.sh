...
version="mc-llava_next_llama3_8b-lora-11-10-craft-craft_table-shell_agent-hard-llama-3-11-13-1"  # {model_version}_{dataset_version}_{training_date}"
...
export WANDB_NOTES="[24-11-13] 110.3k vision language convs convs (instruction state action),with image augment"
